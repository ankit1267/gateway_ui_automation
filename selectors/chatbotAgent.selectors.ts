export const ChatbotAgentCreateSelectors = {
    mySpace: 'text=My space',
    createAgentButton: 'role=button[name="+ Create New Chatbot Agent"]',
    ...
    chatbotToggleButton: '#main-slider-toggle-button',
    chatbotModeButton: 'role=button[name="Chatbot"]',
