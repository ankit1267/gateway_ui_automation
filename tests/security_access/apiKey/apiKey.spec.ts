...
test.describe('API Keys - CRUD Operations', () => {
  ...
  test('TC-APIKEY-01: Create new API key with name, value, limit, period and service', async ({ sidepanel }) => {
    await sidepanel.apiKeysPage.createApiKey(API_KEY_NAME, API_KEY_VALUE, API_KEY_SERVICE, undefined, API_KEY_LIMIT, API_KEY_RESET_PERIOD);
  ...
  test('TC-APIKEY-07: Modal - fill name, apikey and cancel', async ({ sidepanel }) => {
